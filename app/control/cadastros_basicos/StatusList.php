...
class StatusList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de status");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['StatusForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('StatusList', 'onDelete'));
