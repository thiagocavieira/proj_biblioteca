...
class StatusForm extends TPage
{
    ...
    private static $formName = 'form_Status';
    ...
    public function __construct( $param )
    {
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['StatusList', 'onShow']), 'far:arrow-alt-circle-left #3c8dbc');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $messageAction = new TAction(['StatusList', 'onShow']);   
