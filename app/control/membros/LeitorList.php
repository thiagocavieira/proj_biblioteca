...
class LeitorList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_Leitor';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de leitores");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['LeitorForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('LeitorForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('LeitorList', 'onDelete'));
