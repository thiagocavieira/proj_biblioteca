...
class ColecaoList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Colecao';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Colecao';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de coleções");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ColecaoForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('ColecaoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ColecaoList', 'onDelete'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Colecao
