...
class ClassificacaoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de classificacao");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['ClassificacaoList', 'onShow']), 'far:arrow-alt-circle-left #3c8dbc');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $messageAction = new TAction(['ClassificacaoList', 'onShow']);   
