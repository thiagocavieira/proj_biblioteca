...
class ClassificacaoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de classificações");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ClassificacaoForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('ClassificacaoList', 'onDelete'));
