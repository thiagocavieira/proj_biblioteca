...
class EmprestimoColecaoChart extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Empréstimos por coleção");
    ...
    public function onGenerate()
    {
        try
        {
            ...
            if ($objects)
            {
                ...
                {
                    $group1 = $obj->exemplar->livro->colecao->nome;
