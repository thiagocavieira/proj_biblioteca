...
class EmprestimoDiaChart extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Empréstimos por dia");
        ...
        $row4 = $this->form->addFields([new TLabel("Data prevista de devolução:", null, '14px', null)],[$dt_previsao],[new TLabel("Data prevista de devolução final", null, '14px', null)],[$dt_prevista_devolucao_final]);
    ...
    public function onGenerate()
    {
        try
        {
            ...
            if ($objects)
            {
                ...
                {
                    $group1 = $obj->dt_emprestimo;
                    $group1 = TDateTime::convertToMask($group1, 'yyyy-mm-dd', 'd');
