...
trait BuilderMasterDetailFieldListTrait
{
     ...
     */
    public function storeItems($model, $foreign_key, $master_object, $fieldList, Callable $transformer = null)
    {
     ...
     * @param $transformer Function to be applied over the objects
     */
    public function loadItems($model, $foreign_key, $master_object, $fieldList, Callable $transformer = null)
    {
        $fieldList->addHeader();
